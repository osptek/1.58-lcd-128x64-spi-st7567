...
<p align="center"><b>LCD 模组 · SPI · ST7567 · 多版本索引</b></p>
...
本仓库收录 **1.58 寸 128×64 LCD（SPI · ST7567）** 显示模组资料。

**根目录 README 为导航页**。下表可快速浏览各版本；点击「完整资料」进入 `versions/` 下对应**料号文件夹**（产品页、规格书、示例均在该目录内）。

规格标识（仓库名）：`1.58-lcd-128x64-spi-st7567`
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| LCD12864-1937 | <img alt="LCD12864-1937" src="./versions/LCD12864-1937/images/product.png" width="120" /> | [简介](#lcd12864-1937) | [完整资料](./versions/LCD12864-1937/) |
...
完整产品页、规格书与示例：[versions/LCD12864-1937/](./versions/LCD12864-1937/)
